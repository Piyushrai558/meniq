...
export default function Dashboard() {
  ...
  const createMenu = async () => {
    if (!newMenuName.trim()) {
      ToastContext.show("Please enter a menu name");
      return;
    }
    try {
      const data = await api("POST", "/menus", {
        name: newMenuName,
        restaurant_name: newMenuRName,
      });
      setModalOpen(false);
      setNewMenuName("");
      setNewMenuRName("");
                ...
                <div className="menu-card" key={m.id}>
                  ...
                  <div className="menu-card-body">
                    ...
                    <div className="menu-card-meta">
                      {m.section_count} sections · {m.item_count} items
                    </div>
        ...
        <Modal open={modalOpen} onClose={() => setModalOpen(false)}>
          ...
          <div className="form-group">
            ...
            <input
              ...
              placeholder="e.g. Dinner Menu, Lunch Special…"
              value={newMenuName}
          ...
          <div className="form-group">
            ...
            <input
              ...
              value={newMenuRName}
              onChange={(e) => setNewMenuRName(e.target.value)}
              onKeyDown={(e) => e.key === "Enter" && createMenu()}
            />
          </div>
          <div className="modal-actions">
            ...
            <button className="btn-primary" onClick={createMenu}>
              Create menu
            </button>
          </div>
        </Modal>
